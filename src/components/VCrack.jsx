  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">
        Vigenère Cipher Cracker <br></br>
        <span style={{ fontSize: 13, color: "red" }}>
          This craker is using Your-CPU so increasing Iterations will give good
          result but but at the expense of Your CPU, so try to use under 100
          Iterations or increase of the result not good.
        </span>
      </h1>
      <div className="mb-4">
